...
import w3_aleph.Comms;

public class Util {
	
	public static enum MoveOrder {
		BEFORE, // move before attack
		AFTER, // move after attack
		NONE
	}
	...
	/*
	 * this might be somewhat of an expensive method
	 */
